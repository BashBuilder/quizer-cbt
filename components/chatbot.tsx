...
export function Chatbot() {
    ...
    return (
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          size="lg"
          className="h-14 w-14 animate-pulse rounded-full shadow-lg transition-all hover:shadow-xl"
        >
          <MessageCircle className="h-6 w-6" />
        </Button>
        <div className="absolute -right-2 -top-2 h-4 w-4 animate-bounce rounded-full bg-red-500" />
      </div>
    );
  }
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Card
        className={`w-96 overflow-hidden p-0 shadow-2xl transition-all duration-300 ${isMinimized ? "h-16" : "h-[500px]"}`}
      >
        ...
        {!isMinimized && (
          <CardContent className="flex h-[410px] flex-col p-0">
            <ScrollArea className="h-[200px] flex-1 p-4">
